...
Gem::Specification.new do |s|
  ...
  s.homepage = "http://prometheus.rubyforge.org/flattendb"
  s.rdoc_options = ["--charset", "UTF-8", "--line-numbers", "--all", "--title", "flattendb Application documentation (v0.2.0)", "--main", "README"]
  s.require_paths = ["lib"]
